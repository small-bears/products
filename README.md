...
#### 项目获取地址:https://www.666bear.com/12445.html
...
https://www.bilibili.com/video/BV1H6yYBgEZa/?spm_id_from=333.1387.search.video_card.click&vd_source=e51e8ec2fb03314ad9fa517492a2ce94

#### 三、 项目介绍
基于SpringBoot的高校请假管理系统包含教师、管理员、学生三个模块，具体功能如下：

1. 教师模块（教师使用）
功能覆盖：系统首页、学生管理、公告信息、请假记录、考勤记录、个人中心
2. 管理员模块（系统管理角色使用）
拥有全局管理权限，功能包括：系统首页、学生管理、教师管理、请假类型管理、公告信息、请假记录、考勤记录、系统日志、个人中心
3. 学生模块（学生使用）
功能聚焦请假及个人事务：系统首页、公告信息、请假记录、考勤记录、个人中心
